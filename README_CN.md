...
- **📋 自选股页（/watch）** — 独立页面：搜索添加/移除沪深港美标的，沿用统一报价中心实时刷新，localStorage 持久化。不含板块热力、快讯、美债、商品、AI 面板或收益率曲线。
...
├── src/
│   ├── App.tsx        # 大屏布局与路由（/ 市场驾驶舱、/watch 自选股、/ai AI观察、/goods 商品价格、/fin 财报窗口）
│   ├── WatchDashboard.tsx # 独立自选股页（搜索/添加/移除/实时报价，无驾驶舱组件）
